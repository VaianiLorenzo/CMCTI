...
def train_model(cfg, model, device, n_epochs, optimizer, scheduler, train_dataloader, val_dataloader,
    ...
    for epoch in range(0, n_epochs):
        ...
        f = open(f"logs/log_{cfg.MODEL.MULTITASK_MODALITY[0]}{cfg.MODEL.MULTITASK_MODALITY[1]}{cfg.MODEL.MULTITASK_MODALITY[2]}_{cfg.TRAINING.CONSISTENCY_AB}{cfg.TRAINING.CONSISTENCY_AC}.txt", "a+")
